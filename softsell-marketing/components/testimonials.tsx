...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="section-spacing gradient-bg" ref={sectionRef}>
      <div className="container-custom">
        <div className="mb-16">
          <h2 className="section-heading">
            <span className="heading-decoration">What Our</span>What our Customers Say
          </h2>
        </div>
        ...
        >
          ...
          >
            {testimonials.map((testimonial, index) => (
              <div key={index} className="testimonial-item" style={{ width: `${40 / testimonials.length}%` }}>
                <div className="testimonial-card mx-4" onMouseMove={handleMouseMove}>
